...
Token Lexer::scanToken() {
    ...
    switch (c) {
        ...
        case '-': return makeToken(match('-') ? TokenType::MINUS_MINUS : (match('=') ? TokenType::MINUS_EQUAL : TokenType::MINUS));
        case '+': return makeToken(match('+') ? TokenType::PLUS_PLUS : (match('=') ? TokenType::PLUS_EQUAL : TokenType::PLUS));
